# Contributing to skillattice

Thank you for your interest in contributing to skillattice! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/skillattice.git
   cd skillattice
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/skillattice.git
   ```
...
By contributing to skillattice, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
